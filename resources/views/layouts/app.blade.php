                        ...
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item">
                                @if (Request::is('showGroceryList/*'))
                                    <a class="nav-link active"
                                        href="{{ route('groceryList', [Auth::user()->id]) }}">Grocery List</a>
                            ...
                            <li class="nav-item">
                                @if (Request::is('products'))
                                    <a class="nav-link active" href="{{ route('products.index') }}">Grocery Products</a>
                                @else
                                    <a class="nav-link" href="{{ route('products.index') }}">Grocery Products</a>
                                @endif
                            </li>
